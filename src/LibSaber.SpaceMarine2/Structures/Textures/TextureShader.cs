...
namespace LibSaber.SpaceMarine2.Structures.Textures
{
  ...
  public class TextureShader : ITextureNameProvider
  {
    ...
    [ScriptingProperty("distortSecondLayer")]
    public ShaderDistortion DistortSecondLayer { get; set; }
    ...
    [ScriptingProperty("layerFirst")]
    public ShaderLayer LayerFirst { get; set; }
    ...
    [ScriptingProperty( "colorization" )]
    public ShaderColorization Colorization { get; set; }

    [ScriptingProperty( "second_spec" )]
    public ShaderSecondSpec SecondSpec { get; set; }

    [ScriptingProperty( "alphaLevelStart" )]
    public Single AlphaLevelStart { get; set; }

    [ScriptingProperty("alphaLevelEnd")]
    public Single AlphaLevelEnd { get; set; }

    [ScriptingProperty("edgeHighlight")]
    public ShaderEdgeHighlight EdgeHighlight { get; set; }

    [ScriptingProperty("scrollSpeedScaleX")]
    public Single ScrollSpeedScaleX { get; set; }

    [ScriptingProperty("scrollSpeedScaleY")]
    public Single ScrollSpeedScaleY { get; set; }

    [ScriptingProperty("vertex_pulsation")]
    public TextureVertexPulsation VertexPulsation { get; set; }

    [ScriptingProperty("temporalAA")]
    public ShaderTemporalAA TemporalAA { get; set; }

    [ScriptingProperty("doubleSidedLighting")]
    public string DoubleSidedLighting { get; set; }

    [ScriptingProperty("backFaceSpecMult")]
    public float BackfaceSpecMult { get; set; }

    [ScriptingProperty("reflectance")]
    public float Reflectance { get; set; }

    [ScriptingProperty("porosity")]
    public float Porosity { get; set; }

    [ScriptingProperty("transpWriteDepth")]
    public bool TransWriteDepth { get; set; }

    [ScriptingProperty("blurShadows")]
    public string BlurShadows { get; set; }

    [ScriptingProperty("allowHashedTransparent")]
    public bool AllowHashedTransparent { get; set; }

    [ScriptingProperty("autoTextureScaling")]
    public bool AutoTextureScaling { get; set; }

    [ScriptingProperty("fresnelHighlight")]
    public ShaderFresnel FresnelHighlight { get; set; }

    [ScriptingProperty("metallicTint")]
    public SaberColor MetallicTint { get; set; }

    [ScriptingProperty("fuzzy")]
    public ShaderFuzzy Fuzzy { get; set; }

    [ScriptingProperty("occlusionMask")]
    public ShaderOcclusionMask OcclusionMask { get; set; }

    [ScriptingProperty("terr_blend")]
    public ShaderTerrBlend TerrBlend { get; set; }
